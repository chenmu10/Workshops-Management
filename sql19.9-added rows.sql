...
CREATE TABLE IF NOT EXISTS Prepare_School_WorkShop (
	Prepare_School_WorkShop_ID INTEGER NOT NULL AUTO_INCREMENT,
	WorkShop_Number_Of_Final_Student INTEGER,
    ...
    PRIMARY KEY (Prepare_School_WorkShop_ID),
    FOREIGN KEY (Workshop_School_Workshop_ID) references SchoolWorkShop(WorkShop_ID),
    UNIQUE (Workshop_School_Workshop_ID)
);
INSERT INTO prepare_school_workshop	VALUES(null,55,55,true,	true,true,true,	'הערות מטופס הכנה','רינה המורה','052-5465468','chenmu10@gmail.com', 5);
