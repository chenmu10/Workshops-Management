...
namespace gui.Gui
{
    public partial class SchoolEditInfo : System.Web.UI.Page
    {
        ...
        {
            School school = db.GetSchoolByID(int.Parse(Session["SelectedSchool"].ToString()));
            school.School_Name = schoolNameText.Text;
            school.School_Address=schooladdressText.Text;
            school.School_City= schoolCityText.Text;
            school.School_Parking_Info = parkingText.Text;
            school.School_Supervisor_Name = computercontactText.Text ;
            school.School_Supervisor_Phone= computercontactphoneText.Text ;
            school.School_Contact_Name= contactnameText.Text;
            school.Scool_Contact_Phone =contactphoneText.Text;
            school.School_Contact_Email= contactemailText.Text;

            if(!db.updateSchool(school))
