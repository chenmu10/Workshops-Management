...
namespace gui
{
    public partial class Default    : System.Web.UI.Page
    {
        ...
        private void InsertVolunteerToDB()
        {
            ...
            int training = Convert.ToInt32(DropDownListTraining.SelectedValue);
            string reference;
            ...
            Volunteer NewVolunteer = new Volunteer(firstnamevalue, firstnameEngValue, lastnamevalue, lastnameEngValue, emailvalue, phonevalue, occupation, reference, SelectedAreas, employervalue, 0, training);
        ...
        private bool IsAreaChecked() // check if user choose at least one area
        {
            foreach (ListItem item in CheckBoxListAreas.Items)
            {
                if (item.Selected)
